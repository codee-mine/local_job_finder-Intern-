...
class EmployerNotification extends StatefulWidget {
  const EmployerNotification({super.key});

  @override
  State<EmployerNotification> createState() => _EmployerNotificationState();
}

class _EmployerNotificationState extends State<EmployerNotification> {
  bool _allRead = false;
